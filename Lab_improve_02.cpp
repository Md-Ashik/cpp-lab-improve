...
int main()
{
    BookCetegory A("Fiction","Fiction Book","Jawad Siddique",500,20,5);
    BookCetegory B("Non-Fiction","A book of Non Fiction","M. Rahman",450,25,7);
    BookCetegory C("Comic","A good book on Comic","A.R. Hossain",400,18,6);
